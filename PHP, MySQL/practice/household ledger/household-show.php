...
if (! total)
	...
	while ( $i < $total ) :
		...
		echo ("
					...
					<td>$wexpense</td>
					<td>$balance</td>
					<td><a href='household-modify.php?mdate=$wdate'>[M]</a>/<a href='household-delete.php?ddate=$wdate'>[X]</a></td>
					</tr>
				");
	...
	// 최종 출력
	echo ("<table border=0 width=850><tr><td align=right>");
